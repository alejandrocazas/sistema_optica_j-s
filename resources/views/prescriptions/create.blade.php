        ...
        <form action="{{ route('prescriptions.store', $patient->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="diagnostico" class="w-full p-3 border border-gray-200 rounded-sm bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:text-white focus:ring-1 focus-gold outline-none appearance-none cursor-pointer">
                            ...
                            <option value="Hipermetropía con Astigmatismo">Hipermetropía con Astigmatismo</option>
                        </select>
